...
export const HomePage = () => {
  ...
  return (
    <div className="space-y-16 pb-16">
      {/* Hero Section */}
      <section className="relative bg-primary-900 rounded-3xl overflow-hidden shadow-xl">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 flex flex-col items-center text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white tracking-tight mb-6">
            Discover Your Next <span className="text-primary-300">Favorite Thing</span>
          </h1>
          <p className="text-lg md:text-xl text-primary-100 max-w-2xl mb-10">
            Explore our curated collection of premium products. Fast shipping, easy returns, and exceptional customer service.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-8">
          <div>
            <h2 className="text-3xl font-bold text-secondary-900 tracking-tight">Featured Products</h2>
          ...
          <Link to="/products" className="text-primary-600 hover:text-primary-700 font-medium flex items-center group">
            View All <FiArrowRight className="ml-1 w-4 h-4 transform group-hover:translate-x-1 transition-transform" />
          </Link>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-xl font-bold text-secondary-900 mb-2">Free Shipping</h3>
              <p className="text-secondary-500">On all orders over $50. Delivered right to your door.</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="bg-primary-50 p-4 rounded-full mb-4 text-primary-600">
                <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
              </div>
              <h3 className="text-xl font-bold text-secondary-900 mb-2">Secure Payments</h3>
              <p className="text-secondary-500">Your information is protected by industry-leading encryption.</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="bg-primary-50 p-4 rounded-full mb-4 text-primary-600">
              ...
              <h3 className="text-xl font-bold text-secondary-900 mb-2">Easy Returns</h3>
              <p className="text-secondary-500">Not satisfied? Return within 30 days for a full refund.</p>
            </div>
          </div>
        </div>
      </section>
